/*
 * 2011 Francesco
 * Aggiunti i nuovi CONTENT_TYPE supportati da birt 3.7 CONTENT_TYPE_PPT CONTENT_TYPE_ODT CONTENT_TYPE_ODS CONTENT_TYPE_ODP CONTENT_TYPE_PS
 * 
...
{		
	...
	public static final String CONTENT_TYPE_PPT = "application/mspowerpoint";
	...
	public static final String CONTENT_TYPE_ODP = "application/vnd.oasis.opendocument.presentation";
	...
	{	
		...
		else if (contentType.equals(CONTENT_TYPE_DOC))
		{
			return ".doc";
		}		
		else if (contentType.equals(CONTENT_TYPE_PPT))
		{
			return ".ppt";
		}
		else if (contentType.equals(CONTENT_TYPE_ODT))
		{
			return ".odt";
		}			
		else if (contentType.equals(CONTENT_TYPE_ODS))
		{
			return ".ods";
		}							
		else if (contentType.equals(CONTENT_TYPE_ODP))
		{
			return ".odp";
		}					
		else if (contentType.equals(CONTENT_TYPE_PS))
		{
			return ".ps";
		}					
		return "";
