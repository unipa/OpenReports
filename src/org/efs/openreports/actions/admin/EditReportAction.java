/*
 * 2011	Francesco
 * Aggiunti i campi pptExportEnabled, odpExportEnabled, odsExportEnabled, odtExportEnabled, psExportEnabled, htmlEmbeddedExportEnabled;
 * per supportare i nuovi tipi di ritorno presenti dalla versione birt 3.7.1 
 * 
 * 
...
{	
	...
	private boolean pptExportEnabled;
	private boolean odpExportEnabled;
	private boolean odsExportEnabled;
	private boolean odtExportEnabled;
	private boolean psExportEnabled;
	private boolean htmlEmbeddedExportEnabled;
	...
	public String execute()
	{
		try
		{
			...
			if (command.equals("edit") && !submitOk && !submitValidate && !submitDuplicate)
			{
				...
				pptExportEnabled = report.isPptExportEnabled();
				odpExportEnabled = report.isOdpExportEnabled();
				odsExportEnabled = report.isOdsExportEnabled();
				odtExportEnabled = report.isOdtExportEnabled();		
				psExportEnabled  = report.isPsExportEnabled(); 
				htmlEmbeddedExportEnabled = report.isHtmlEmbeddedExportEnabled();
			...
			report.setPptExportEnabled(new Boolean(pptExportEnabled));
			report.setOdpExportEnabled(new Boolean(odpExportEnabled));
			report.setOdsExportEnabled(new Boolean(odsExportEnabled));
			report.setOdtExportEnabled(new Boolean(odtExportEnabled));	
			report.setPsExportEnabled(new Boolean(psExportEnabled));
			report.setHtmlEmbeddedExportEnabled(new Boolean(htmlEmbeddedExportEnabled));
	...
	public boolean isPptExportEnabled() {
		return pptExportEnabled;
	}

	public void setPptExportEnabled(boolean pptExportEnabled) {
		this.pptExportEnabled = pptExportEnabled;
	}

	public boolean isOdpExportEnabled() {
		return odpExportEnabled;
	}

	public void setOdpExportEnabled(boolean odpExportEnabled) {
		this.odpExportEnabled = odpExportEnabled;
	}

	public boolean isOdsExportEnabled() {
		return odsExportEnabled;
	}

	public void setOdsExportEnabled(boolean odsExportEnabled) {
		this.odsExportEnabled = odsExportEnabled;
	}

	public boolean isOdtExportEnabled() {
		return odtExportEnabled;
	}

	public void setOdtExportEnabled(boolean odtExportEnabled) {
		this.odtExportEnabled = odtExportEnabled;
	}

	public boolean isPsExportEnabled() {
		return psExportEnabled;
	}

	public void setPsExportEnabled(boolean psExportEnabled) {
		this.psExportEnabled = psExportEnabled;
	}

	public boolean isHtmlEmbeddedExportEnabled() {
		return htmlEmbeddedExportEnabled;
	}

	public void setHtmlEmbeddedExportEnabled(boolean htmlEmbeddedExportEnabled) {
		this.htmlEmbeddedExportEnabled = htmlEmbeddedExportEnabled;
	}
