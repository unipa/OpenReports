 ...
 * Aggiunti all'enumerazione ExportType o valori PPT(9), ODP(10), ODS(11), ODT(12), PS(13) 
...
public class ReportConstants 
{
	 ...
	 */
	public enum ExportType {PDF(0), XLS(1), HTML(2), CSV(3), IMAGE(4), RTF(5), TEXT(6), EXCEL(7), HTML_EMBEDDED(8), PPT(9), ODT(10), ODS(11), ODP(12), PS(13) ;
