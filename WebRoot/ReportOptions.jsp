...
<div align="center">
  ...
  <table class="dialog" >    
    <tr>
      ...
      <s:if test="report.htmlEmbeddedExportEnabled">        
      <td>
        <input type="radio" name="exportType" value="8">HTML EMBEDDED
      </td>
      </s:if>        
      <s:if test="report.pptExportEnabled">        
	  <td>
	  	<input type="radio" name="exportType" value="9">PPT
	  </td>
	  </s:if>
	  <s:if test="report.odtExportEnabled">        
	  <td>
	  	<input type="radio" name="exportType" value="10">ODT
	  </td>
	  </s:if>
	  <s:if test="report.odsExportEnabled">        
	  <td>
	  	<input type="radio" name="exportType" value="11">ODS
	  </td>
	  </s:if>
	  <s:if test="report.odpExportEnabled">        
	  <td>
	        <input type="radio" name="exportType" value="12">ODP
	  </td>
	  </s:if>
	  <s:if test="report.psExportEnabled">        
	  <td>
	  	<input type="radio" name="exportType" value="13">Postscript
	  </td>
	  </s:if> 
