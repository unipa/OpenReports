      ...
      <table>    
        ...
        <tr class="b">
          ...
          <td>
            ...
            <s:checkbox name="htmlEmbeddedExportEnabled"  fieldValue="true" theme="simple"/>HTML EMBEDDED
        ...
        <tr class="b">
          <td class="boldText">Export esclusivi ReportEngine Birt 3.7</td>
          <td>
          	<img  id="export" src="images/help.gif" title="Export esclusivi ReportEngine Birt 3.7">      	
          </td>
          <td>
            <s:checkbox name="pptExportEnabled" fieldValue="true" theme="simple"/>PPT
            <s:checkbox name="odpExportEnabled" fieldValue="true" theme="simple"/>ODP
            <s:checkbox name="odsExportEnabled" fieldValue="true" theme="simple"/>ODS
            <s:checkbox name="odtExportEnabled" fieldValue="true" theme="simple"/>ODT
            <s:checkbox name="psExportEnabled"  fieldValue="true" theme="simple"/>POSTSCRIPT
